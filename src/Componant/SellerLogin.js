...
const SellerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8080/api/v1/Seller/login",{
        method: 'POST',
        headers: {
  ...
  return (
    ...
    <div className="login-box">
      ...
      <table>
        <tr><td><a href="/admin">Admin Login</a></td>
        <td className='color'><a href="/seller">Seller Login</a></td>
